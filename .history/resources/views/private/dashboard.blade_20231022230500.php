    ...
    <div class="p-6 w-full relative">
        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <div class="grid grid-cols-2 mt-4 items-center gap-x-6">
                <label id="image1_label" for="image1" class="w-full border border-blue-900 relative overflow-hidden p-4 rounded-xl flex items-center justify-center">
                    <div id="placeholder1" class="text-center">
                        <iconify-icon class="text-4xl" icon="basil:image-outline"></iconify-icon>
                        <p>Foto HWLawyer 1</p>
                    </div>
                    <img src="/assets/images/1.jpg" class="absolute w-full h-full object-cover object-center" alt="">
                </label>
            </div>
