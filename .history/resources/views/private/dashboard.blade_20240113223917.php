            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->news_title }}" type="text" id="news_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->video_title }}" type="text" id="video_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->form_contact_title }}" type="text" id="form_contact_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
                    <label for="area_description" class="block mb-2">Description Bagian Formulir Contact</label>
                    <textarea id="area_description" required class="textarea w-full textarea-bordered h-32">{{ $content->area_description }}</textarea>
                </div>
                <div class="form_control">
                    <label for="contact_title" class="block mb-2">Title Bagian Contact</label>
                    <input value="{{ $content->contact_title }}" type="text" id="contact_title" required maxlength="200" min="0" class="input input-bordered w-full">
                </div>
                <div class="form_control">
                ...
                <div class="form_control">
                    <label for="contact_description" class="block mb-2">Description Bagian Footer</label>
                    <textarea id="contact_description" required class="textarea w-full textarea-bordered h-32">{{ $content->contact_description }}</textarea>
                </div>
            </form>
