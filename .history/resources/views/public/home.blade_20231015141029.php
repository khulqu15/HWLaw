...
<div class="relative w-full bg-white pr-12 py-12">
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        ...
        <div class="col-span-3 space-y-3 w-full">
            <div class="w-full p-4 bg-blue-500 rounded-xl relative flex">
                <img src="/assets/images/4.jpg" class="w-48 h-48 rounded-xl object-cover object-center relative" alt="Hallo Moshi Moshi">
                <div class=""></div>
            </div>
