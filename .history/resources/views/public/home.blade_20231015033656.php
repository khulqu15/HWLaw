...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 gap-x-8 items-center relative px-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
    <div class="absolute w-full h-full object-cover object-center bg-blue-900/80"></div>
    <div class="relative text-white">
        <h4 class="text-4xl font-bold mb-3">Meeting Your Legal Justice Requirements</h4>
        <p class="text-sm">AG Lawfirm telah ada sejak 2021 dengan keahlian di ranah hukum selama 17 tahun, menjadi kantor hukum yang memiliki integritas, responsif, kontemporer, dan selalu up-to-date dengan perubahan hukum di Indonesia. Kami berkomitmen memberikan layanan terbaik kepada klien di berbagai aspek hukum termasuk pidana, perdata, kepailitan, korporasi, perbankan, kontrak, dan hak kekayaan intelektual. Mencapai kebenaran dan keadilan adalah misi kami dalam memberikan saran, sebagai manifestasi dari kepercayaan dan dedikasi kami terhadap supremasi hukum. Inilah beberapa layanan yang kami sediakan</p>
    </div>
    <div class="relative">
        <h4>Memenuhi Kebutuhan Keadilan Hukum Anda</h4>
    </div>
</div>
