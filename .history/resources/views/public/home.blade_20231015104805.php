    ...
    <div class="relative text-center md:mt-0 mt-12">
        ...
        <div class="relative">
            ...
            <div class="flex flex-wrap items-stretch text-left">
                <div class="bg-blue-900 py-4 pr-4 pl-6 text-white lg:rounded-l-2xl w-full lg:w-4/12">
                ...
                <div class="bg-gray-200 p-4 text-blue-900 w-full md:w-4/12 lg:w-1/4">
                    <p class="text-sm font-semibold">Lawyer Berpengalaman</p>
                    <h5 class="text-3xl font-semibold">5+</h5>
                    <p class="text-xs">Tahun</p>
                </div>
                <div class="bg-red-500 p-4 text-white w-full md:w-4/12 lg:w-1/4">
                ...
                <div class="bg-gray-100 p-4 text-red-600 lg:rounded-r-2xl w-full md:w-4/12 lg:w-1/4">
