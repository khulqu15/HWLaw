...
<div class="relative w-full bg-white pr-12 py-12">
    <div class="flex w-full justify-center text-center mb-12">
        <div>
            <p class="text-red-600 mb-4 tracking-wider uppercase md:pt-0 pt-12">DAR TIM HW LAWYER UNTUK MASYARAKAT</p>negara terkait
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        <div class="col-span-5 w-full h-96 bg-blue-500 text-white rounded-r-xl relative">
            <div class="w-full py-6 px-6 absolute left-0 bottom-0 bg-gradient-to-t from-black to-transparent">
                ...
                <p class="text-sm">Adanya perlindungan hukum dalam ketentuan hukum untuk melindungi pihak ketiga yang asetnya dirampas...</p>
            </div>
        </div>
