...
@section('content')
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8 mb-12" id="about_form">
            ...
            <form id="form_content" class="space-y-4 mt-4">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        ...
                        <input value="{{ $content->about_motto }}" type="number" id="year_input" placeholder="cth. 2002" required max="2150" min="1945" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="cases_input" class="block mb-2">Title Bagian About</label>
                        <input value="{{ $content->about_title }}" type="number" id="cases_input" placeholder="cth. 100" required max="999999" min="0" class="input input-bordered w-full">
                    </div>
                </div>
            </form>
