...
document.getElementById('logo_image').addEventListener('change', uploadImageCallback)
document.getElementById('about_image').addEventListener('change', uploadImageCallback)
document.getElementById('area_image').addEventListener('change', uploadImageCallback)
document.getElementById('contact_image').addEventListener('change', uploadImageCallback)
