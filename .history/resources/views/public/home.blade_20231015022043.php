...
<div class="min-h-screen relative px-12">
    <div class="grid md:grid-cols-2 grid-cols-1 items-center">
        <div class="relative">
            <img src="/assets/images/pak.png" class="w-1/2" alt="Pak Harry HW Lawyer">
        </div>
        <div>
            <h1 class="text-2xl">Kami Sangat Menghargai Prinsip Keadilan.</h1>
            <p class="text-sm">HW Lawfirm berdiri berdasarkan hasrat mendalam untuk menawarkan layanan hukum terkini, dinamis, dan ahli dengan tim Advokat, personel, dan sistem manajemen unggulan yang berkomitmen pada etika, keahlian, dan dedikasi tinggi dalam memberikan layanan kepada klien.</p>
        </div>
    </div>
</div>
