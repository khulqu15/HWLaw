    ...
    <div class="w-full bg-white p-8 relative">
        <form id="news_form" class="space-y-4">
            ...
            <div class="form-control">
                ...
                <input id="title_input" value="{{ !isset($news) ? '' : $news->id }}" type="text" required maxlength="42" class="input input-bordered w-full" placeholder="cth. Informasi Update Terkini Di Kota Tulungagung">
            </div>
