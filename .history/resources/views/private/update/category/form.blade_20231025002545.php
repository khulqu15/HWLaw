...
<div class="w-full relative p-8 bg-white">
    <div class="space-y-3">
        <form id="category_form">
            ...
            <div class="w-full mt-3 flex justify-end justify-items-end items-center">
                <a class="btn btn-ghost border border-gray-300">Batal</a>
                <button class="btn bg-blue-900 hover:bg-blue-800 btn-wide" type="sumbit">Simpan</button>
            </div>
        </form>
    </div>
</div>
