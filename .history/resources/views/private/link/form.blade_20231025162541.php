        ...
        <form id="category_form" class="space-y-3">
            <div class="form-control">
                ...
                <div class="input-group">
                    <input id="name_input_text" value="{{ !isset($link) ? '' : $link->name }}" required maxlength="50" placeholder="cth. Whatsapp, Facebook, Twitter, Youtube" type="text" class="w-full input input-bordered" >
