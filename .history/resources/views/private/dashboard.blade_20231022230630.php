    ...
    <div class="p-6 w-full relative">
        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <div class="grid grid-cols-2 mt-4 items-center gap-x-6">
                <label id="image1_label" for="image1" class="image_form w-full border border-blue-900 relative overflow-hidden p-4 rounded-xl flex items-center justify-center">
                ...
                <label id="image2_label" for="image2" class="image_form w-full border border-blue-900 relative overflow-hidden p-4 rounded-xl flex items-center justify-center">
