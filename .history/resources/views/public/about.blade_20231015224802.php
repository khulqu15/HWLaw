...
<div class="bg-gray-100">
    <div class="w-full py-20 container relative mx-auto">
        <div class="grid md:grid-col-2 grid-cols-1 relative">
             <div>
                <h1 class="text-2xl font-bold">Opsi Terbaik dalam Mewujudkan Keadilan Anda</h1>
             </div>
        </div>
    </div>
</div>
