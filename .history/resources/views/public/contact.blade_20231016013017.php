        ...
        <div class="grid md:grid-cols-2 grid-cols-1 gap-6 relative">
            <div>
                ...
                <div class="flex gap-x-3 my-4">
                    <div class="bg-blue-900 text-white h-12 w-12 flex items-center">
                        <iconify-icon icon="heroicons:map-pin-solid" class="text-2xl text-yellow-400"></iconify-icon>
                    </div>
                    <div>
                        <h5 class="text-lg font-semibold mb-2">Lokasi Kami</h5>
                        <span>Jalan Alamat Kantor HW Lawfirm, Tulungangung, Indonesia, 60192</span>
                    </div>
                </div>
