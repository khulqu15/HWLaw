            ...
            <form id="form_about" class="space-y-4 mt-4">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        ...
                        <input type="text" id="vission_input" placeholder="cth. 2002" required maxlength="255" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="mission_input" class="block mb-2">Misi</label>
                        <input type="text" id="mission_input" placeholder="cth. 100" required maxlength="255" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
