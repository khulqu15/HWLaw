            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->about_title }}" type="text" id="about_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->about_point_description }}" type="text" id="about_point_description" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $content->area_title }}" type="text" id="area_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="area_motto" class="block mb-2">Header Bagian Informasi</label>
                        <input value="{{ $content->news_motto }}" type="text" id="area_motto" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="area_title" class="block mb-2">Title Bagian Informasi</label>
                        <input value="{{ $content->news_title }}" type="text" id="area_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="area_motto" class="block mb-2">Header Bagian Video</label>
                        <input value="{{ $content->video_motto }}" type="text" id="area_motto" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="area_title" class="block mb-2">Title Bagian Video</label>
                        <input value="{{ $content->video_title }}" type="text" id="area_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="area_motto" class="block mb-2">Header Bagian Contact</label>
                        <input value="{{ $content->video_motto }}" type="text" id="area_motto" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="area_title" class="block mb-2">Title Bagian Content</label>
                        <input value="{{ $content->video_title }}" type="text" id="area_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
            </form>
