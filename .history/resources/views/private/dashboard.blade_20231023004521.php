        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="year_input" class="block mb-2">Didirikan pada tahun</label>
                        <input type="number" id="year_input" placeholder="cth. 2002" required max="255" min="1945" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="case_input" class="block mb-2">Jumlah kasus yang telah diselesaikan</label>
                        <input type="number" id="case_input" placeholder="cth. 100" required max="255" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
