...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 gap-x-8 items-center relative px-12">
    <div class="relative text-center">
        ...
        <div class="relative">
            ...
            <div class="flex items-stretch text-left">
                <div class="bg-blue-900 py-4 pr-4 pl-6 text-white rounded-l-2xl">
                ...
                <div class="bg-gray-200 p-4 text-blue-900">
                ...
                <div class="bg-gray-100 p-4 text-red-600 rounded-r-2xl">
    ...
    <div>
        <p class="text-red-600 mb-4 tracking-wider uppercase">Tentang Kami HW LAWYER</p>
    ...
    <div class="col-span-2 relative">
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full">
            ...
            <div class="w-full h-64 p-6 border-x-[1px] border-b-[1px] border-blue-900 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                ...
                <h3 class="text-2xl font-semibold mb-2">Hukum Pidana</h3>
                <p>AG Lawfirm memiliki keahlian dalam menyelesaikan kasus pelanggaran hukum serta tuntutan ...</p>
            </div>
