...
<div class="w-full pt-32 pb-12">
    <div class="w-full min-h-[50vh] relative">
        ...
        <img src="/assets/images/{{ $news->cover }}" class="absolute top-0 left-0 w-full h-96 object-center object-cover" alt="{{ $news->cover }}">
        <div class="relative container max-w-md mx-auto px-8 pt-24">
            <img src="/assets/images/{{ $news->cover }}" alt="{{ $news->cover }}">
        </div>
    </div>
</div>
