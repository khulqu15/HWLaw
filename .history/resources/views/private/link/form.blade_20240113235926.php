...
<div class="w-full relative p-8 bg-white">
    <div class="space-y-3">
        <a href="/private/links" class="btn btn-ghost border border-gray-300">Kembali</a>
        <form id="link_form" class="space-y-3">
            <div class="form-control">
                ...
                <div class="input-group">
                    ...
                    <select id="name_input_select" name="name" class="select select-bordered w-full">
                        ...
                        <option value="alamat" {{ (isset($link) && $link->name == 'alamat') ? 'selected' : '' }}>Alamat</option>
                    </select>
            ...
            <div class="form-control">
                ...
                <input id="link_input" value="{{ !isset($link) ? '' : $link->link }}" required placeholder="cth. github.com/khulqu15" type="text" class="w-full input input-bordered" >
            </div>
            <div class="w-full mt-3 flex justify-end justify-items-end items-center gap-x-3">
                <a href="/private/links" class="btn btn-ghost border border-gray-300">Batal</a>
