            ...
            <div class="absolute space-y-3 h-full w-full bg-black/60 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 space-y-3 lg:w-10/12 pt-12 w-full px-4">
                    ...
                    <div class="items-center justify-center gap-x-3 text-left lg:flex hidden">
                        <img src="/assets/images/{{ $content->logo_image }}" alt="HW Logo" class="w-24 inline-block">
...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 gap-x-8 items-center relative px-12">
    <div class="relative text-center md:mt-0 mt-12">
        ...
        <div class="relative">
            <img src="/assets/images/{{ $content->about_image }}" class="w-1/2 mx-auto" alt="Pak Harry HW Lawyer">
            <div class="flex flex-wrap items-stretch text-left">
                <div class="bg-blue-900 py-4 pr-4 pl-6 text-white lg:rounded-l-2xl w-full lg:w-1/4">
                    <h5 class="text-lg font-semibold">{{ $content->about_point_title }}</h5>
                    <p class="text-xs text-white/80">{{ $content->about_point_description }}</p>
                </div>
                ...
                <div class="bg-gray-100 p-4 flex items-center text-red-600 lg:rounded-r-2xl w-full md:w-4/12 lg:w-1/4">
                    <div>
                        ...
                        <h5 class="text-3xl font-semibold">{{ count($practices) }}</h5>
    ...
    <div>
        <p class="text-red-500 mb-4 tracking-wider uppercase md:pt-0 pt-12">{{ $content->about_motto }}</p>
        <h1 class="lg:text-6xl md:text-4xl text-2xl font-bold mb-12">{{ $content->about_title }}</h1>
...
<div id="practice" class="grid md:grid-cols-2 grid-cols-1 gap-x-8 relative items-center md:p-20 p-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
    ...
    <div class="relative text-white">
        <p class="text-yellow-400 mb-4 tracking-wider uppercase md:pt-0 pt-12">{{ $content->area_motto }}</p>
        <h4 class="text-4xl font-bold mb-3">{{ $content->area_title }}</h4>
        <p class="text-sm">{{ $content->area_description }}</p>
    </div>
    <div class="relative">
        <img src="/assets/images/{{ $content->area_image }}" class="w-64 object-center object-cover mx-auto" alt="Pak Harry Lawyer">
    </div>
...
<div class="relative w-full bg-white pr-12 md:pl-0 pl-12 py-12">
    <div class="flex w-full justify-center text-center mb-12">
        <div>
            <p class="text-red-600 mb-4 tracking-wider uppercase md:pt-0 pt-12">{{ $content->news_motto }}</p>
            <h1 class="lg:text-4xl md:text-3xl text-2xl font-bold">{{ $content->news_title }}</h1>
        </div>
    </div>
...
<div class="bg-white p-12 relative bg-fixed bg-center bg-cover">
    <div class="relative flex w-full justify-center text-center mb-12">
        <div>
            <p class="text-red-600 mb-4 tracking-wider uppercase md:pt-0 pt-12">{{ $content->video_motto }}</p>
            <h1 class="lg:text-4xl md:text-3xl text-2xl font-bold">{{ $content->video_title }}</h1>
        </div>
    </div>
