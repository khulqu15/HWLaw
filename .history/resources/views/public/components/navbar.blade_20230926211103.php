<div class="fixed top-0 w-full bg-base-100">
    <div class="w-full bg-red-400 py-1 px-8 text-white flex items-center">
        <div class="flex items-center">
            <iconify-icon class="text-xl" icon="mdi:call"></iconify-icon>
            <span class="text-sm">+62895396004952</span>
        </div>
    </div>
