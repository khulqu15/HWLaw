...
@section('content')
    <div class="w-full bg-white p-8 relative">
        <form id="news_form" class="space-y-4">
            ...
            <input id="id_input" value="{{ !isset($category) ? '' : $category->id }}" type="hidden">
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 gap-3">
                <div class="form-control">
                    ...
                    <input id="date_input" value="{{ !isset($news) ? '' : $news->date }}" type="date" required class="input input-bordered w-full" placeholder="cth. Informasi Update Terkini Di Kota Tulungagung">
                </div>
                <div class="form-control">
                ...
                <div class="form-control">
                    ...
                    <select id="category_input" value="{{ !isset($news) ? '' : $news->category_post_id }}" required class="select select-bordered w-full">
...
document.getElementById('news_form').addEventListener('submit', function(e) {
    ...
    else endpoint = '/private/news/category/update/'+id
