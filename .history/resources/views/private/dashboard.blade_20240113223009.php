    ...
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="about_motto" class="block mb-2">Header Bagian Praktek Area</label>
                        <input value="{{ $content->area_motto }}" type="text" id="about_motto" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="about_title" class="block mb-2">Title Bagian Praktek Area</label>
                        <input value="{{ $content->area_title }}" type="text" id="about_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
                    <label for="about_description" class="block mb-2">Description Bagian Praktek Area</label>
                    <textarea id="about_description" required class="textarea w-full textarea-bordered h-32">{{ $content->area_description }}</textarea>
                </div>
            </form>
