...
<div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 relative items-center md:p-20 p-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
    ...
    <div class="col-span-2 relative grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-1 w-full">
        <div class="w-full h-64 p-6 border-lb-1 border-blue-900 bg-white">
            <h3>Hukum Pidana</h3>
        </div>
        <div class="w-full h-64 p-6 border-lb-1 border-blue-900 bg-white">
            <h3>Hukum Pidana</h3>
