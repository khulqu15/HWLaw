      ...
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[90vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 lg:w-1/2 text-white md:w-3/4 w-full p-8 bg-blue-900 bottom-0 left-0 rounded-tr-2xl">
                ...
                <p class="text-sm">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam vel voluptatem nesciunt maiores praesentium iusto quam nemo corporis, ipsa consequatur nobis ex placeat tempora</p>
            </div>
        </div>
