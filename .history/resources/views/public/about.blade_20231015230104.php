        ...
        <div class="grid md:grid-cols-2 grid-cols-1 relative">
            <div>
                ...
                <div class="mt-6 grid grid-cols-2 items-center">
                    <div class="relative">
                        <div class="w-20 h-20 bg-blue-900 text-white flex items-center justify-items-center justify-center">
                            <iconify-icon icon="octicon:law-24" class="text-4xl"></iconify-icon>
                        </div>
                        <h3 class="text-xl font-semibold">Berkompeten</h3>
                    </div>
                    <div class="relative">
                        <div class="w-20 h-20 bg-red-400 text-black flex items-center justify-items-center justify-center">
                            <iconify-icon icon="akar-icons:hammer" class="text-4xl"></iconify-icon>
                        </div>
                    </div>
                </div>
            </div>
