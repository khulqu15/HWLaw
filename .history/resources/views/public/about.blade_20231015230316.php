            ...
            <div>
                ...
                <div class="mt-6 grid grid-cols-2">
                    <div class="relative">
                        ...
                        <p class="text-sm">Dibackup oleh tim yang memiliki keahlian spesifik di area mereka, serta telah membangun kolaborasi dengan berbagai institusi dan spesialis.</p>
                    </div>
                    <div class="relative">
