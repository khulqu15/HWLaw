            ...
            <div>
                <div class="grid grid-cols-2 items-center">
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full p-12 bg-red-500 flex items-center text-white">
                            <div class="space-y-4">
                                <h2 class="text-black font-bold">Visi Kami</h2>
                                <p class="text-sm text-black/80">Menjadi Pelaksana Keadilan yang objektif, kompeten, berintegritas, dan terhormat.</p>
                            </div>
                        </div>
                    </div>
                </div>
