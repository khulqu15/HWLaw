                ...
                <form>
                    <div class="form-control w-full">
                        <div class="input-group">
                            <input id="name_input" name="name" type="text" class="input text-sm w-full input-bordered" placeholder="Cari Berdasarkan Nama">
                            <button class="btn btn-primary bg-primary text-primary" type="submit">
