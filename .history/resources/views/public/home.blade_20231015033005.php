...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 gap-x-8 items-center relative px-12 bg-blue-900 relative">
    <img src="/assets/images/6.jpg" alt="HW Lawyer Activity" class="absolute w-full h-full object-cover object-center">
</div>
