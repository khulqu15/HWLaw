<div class="bg-blue-900 pt-12 relative bg-fixed bg-center bg-cover" style="background-image: url('/assets/images/4.jpg')">
    ...
    <div class="relative md:px-24 px-12 py-20 grid grid-cols-3 gap-6 items-center" id="footer">
        <div class="absolute w-full h-full bg-gradient-to-t from-black to-transparent"></div>
        <div class="absolute w-3/4 border-t-1 border-white text-white">
            <p>Copyright &copy; AG Law Firm 2022 – All Rights Reserved. Support by <a href="https://www.webnesia.com" target="_blank" rel="noopener noreferrer">WebNesia</a></p>
        </div>
        <div class="relative">
