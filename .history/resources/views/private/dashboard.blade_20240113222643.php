            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        ...
                        <input value="{{ $content->about_motto }}" type="text" id="year_input" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="cases_input" class="block mb-2">About Poin 1 Description</label>
                        <input value="{{ $content->about_title }}" type="text" id="cases_input" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
            </form>
