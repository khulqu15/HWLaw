...
@section('navbar')
    @if (!isset($category)) Tambah Link Kontak
    ...
    <div class="space-y-3">
        ...
        <form id="category_form">
            <div class="form_control">
                ...
                <input id="name_input" value="{{ !isset($category) ? '' : $category->name }}" required maxlength="50" placeholder="cth. Berita, Artikel" type="text" class="w-full input input-bordered" >
            </div>
