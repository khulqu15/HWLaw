  ...
  <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[100vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 h-full w-full bg-blue-900/30 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="flex text-center space-y-3 lg:w-3/4 w-full px-4">
                    <div>
                        <p>Integritas yang Tak Tergoyahkan</p>
                    </div>
                    <div>
