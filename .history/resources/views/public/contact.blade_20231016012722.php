    ...
    <div class="w-full py-20 container relative mx-auto md:px-12 px-4">
        <div class="grid md:grid-cols-2 grid-cols-1 gap-6 relative">
            <div>
                ...
                <p class="text-black/70">Jika Anda memiliki pertanyaan atau ingin melakukan konsultasi, silahkan hubungi kami melalui form atau informasi kontak yang ada di halaman ini. Dengan senang hati kami akan membalas pesan Anda secepatnya.
