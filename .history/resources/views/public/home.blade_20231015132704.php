...
<div class="relative w-full bg-white pr-12 py-12">
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        <div class="col-span-5 w-full h-96 bg-blue-900 text-white rounded-r-xl relative">
            <h3 class="md:text-2xl text-xl font-bold">Perlindungan Hukum Terhadap Pihak Ketiga Dalam Perkara Tipikor</h3>
        </div>
