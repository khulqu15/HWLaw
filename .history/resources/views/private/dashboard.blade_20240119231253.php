    ...
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="form_control">
                    <label for="year_input" class="block mb-2">Judul pada halaman profil</label>
                    <input value="{{ $about->about_title }}" type="number" id="year_input" placeholder="cth. 2002" required max="2150" min="1945" class="input input-bordered w-full">
                </div>
                <div class="form_control">
                    <label for="description_input" class="block mb-2">Deskripsi pada halaman profil</label>
