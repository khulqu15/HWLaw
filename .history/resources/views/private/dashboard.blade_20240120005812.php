                ...
                <div class="grid md:grid-cols-3 grid-cols-1 gap-8 mt-4">
                    ...
                    <div class="md:col-span-2">
                        <div class="form_control">
                            ...
                            <input value="" type="text" id="benefit_title" required max="2150" min="1945" class="input input-bordered w-full">
                        </div>
                        <div class="form_control">
                ...
                <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                    @foreach ($benefit as $item)
                        <div class="relative p-6 shadow-xl rounded-xl">
                            ...
                            <form>
                                <input value="{{ $item->id }}" type="hidden" id="benefit_title" required max="2150" min="1945" class="input input-bordered w-full">
                                <button class="btn bg-red-500 text-white btn-sm mt-3">Hapus</button>
                            </form>
                        </div>
                    @endforeach
                </div>
