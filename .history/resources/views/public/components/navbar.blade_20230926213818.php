<div class="fixed top-0 w-full bg-base-100">
    ...
    <div class="flex items-center py-4 px-8 justify-between">
        ...
        <div class="lg:hidden inline-block">
            <button class="btn bg-red-400 transition-all hover:bg-red-500 text-white text-2xl p-2">
                <iconify-icon icon="jam:menu"></iconify-icon>
            </button>
        </div>
    </div>
    <div class="lg:hidden inline-block w-full">
        <div class="w-full py-4 px-8 bg-base-100">
            <ul class="w-full">
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full">About</li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full">Our Team</li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full">Practice</li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full">Update</li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full">Career</li>
            </ul>
        </div>
    </div>
</div>
