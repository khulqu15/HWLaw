  ...
  <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[80vh] bg-blue-500 relative">
            ...
            <div class="absolute lg:w-1/2 md:w-3/4 w-full p-4 bg-blue-900 bottom-16 right-8 rounded-xl"></div>
        </div>
        <div class="absolute flex justify-between transform -translate-y-1/2 left-0 top-1/2">
