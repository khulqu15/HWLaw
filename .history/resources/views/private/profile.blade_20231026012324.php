            ...
            <form method="POST" action="/private/profile/{{ $user->id }}" id="form_about" class="space-y-4 mt-4">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        ...
                        <input name="password" type="password" id="password_input" required class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="repassword_input" class="block mb-2">Konfirmasi Password</label>
                        <input name="repassword" type="password" id="repassword_input" required class="input input-bordered w-full">
                    </div>
                </div>
