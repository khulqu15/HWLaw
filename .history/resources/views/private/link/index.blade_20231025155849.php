                ...
                <table class="table table-zebra">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $link->name }}</td>
                            <td>{{ count($link->post) }}</td>
                            <td class="flex items-center gap-x-3">
                                <a class="btn btn-success btn-sm" href="/private/news/category/edit/{{$link->id}}">Edit</a>
                                <form action="/private/news/category/delete/{{$link->id}}" method="POST">
