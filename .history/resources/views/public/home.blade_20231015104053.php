    ...
    <div class="relative text-center md:mt-0 mt-12">
        ...
        <div class="relative">
            ...
            <div class="flex flex-wrap items-stretch text-left">
                <div class="bg-blue-900 py-4 pr-4 pl-6 text-white md:rounded-l-2xl w-full md:w-1/4">
                ...
                <div class="bg-gray-100 p-4 text-red-600 rounded-r-2xl w-full md:w-1/4">
