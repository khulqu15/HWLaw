    ...
    <div class="w-full bg-white p-8 relative">
        <div class="space-y-4">
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 gap-3">
                <div class="form-control">
                    <label for="title_input" class="block mb-2">Keterangan Waktu</label>
                    <input type="text" required maxlength="42" class="input input-bordered w-full" placeholder="cth. Informasi Update Terkini Di Kota Tulungagung">
                </div>
                <div class="form-control">
                    <label for="title_input" class="block mb-2">Keterangan Tempat</label>
                    <input type="text" required maxlength="42" class="input input-bordered w-full" placeholder="cth. Informasi Update Terkini Di Kota Tulungagung">
                </div>
                <div class="form-control">
                    <label for="title_input" class="block mb-2">Kategori Informasi</label>
                    <input type="text" required maxlength="42" class="input input-bordered w-full" placeholder="cth. Informasi Update Terkini Di Kota Tulungagung">
                </div>
            </div>
        </div>
