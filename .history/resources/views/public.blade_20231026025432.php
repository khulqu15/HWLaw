...
<body>
    ...
    @foreach ($contact as $item)
        ...
        <div class="fixed bottom-0 right-0 p-4">
            <a href="https://wa.me/{{ $item->link }}?text=Saya%20membutuhkan%20bantuan%20hukum.%20Bisakah%20kita%20berbicara?" role="button" class="tooltip tooltip-left tooltip-success flex items-center justify-center w-16 h-16 hover:scale-105 transition-all text-white rounded-full bg-green-600" data-tip="Hubungi Kami Sekarang!">
