                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="relative">
                            <div class="form-group">
                                ...
                                <textarea id="name" name="name" required placeholder="cth. Bagaimana Prosedur Konsultasi Untuk Kasus Pidana Korupsi ?" class="textarea textarea-bordered h-12 w-full"></textarea>
                            </div>
                            <div class="w-full text-right">
                                <button class="btn bg-blue-900 btn-wide hover:bg-blue-800 text-white">Kirim</button>
                            </div>
                        </div>
                    </div>
                </form>
