            ...
            <div class="w-full grid p-8 grid-cols-1 relative justify-center justify-items-center">
                ...
                <div class="w-full bg-blue-900 p-8 mt-12 relative flex">
                    ...
                    <div class="lg:w-1/2 md:w-3/4 w-full relative">
                        ...
                        <div id="emaillink" data-email="@foreach ($contact as $item) @if ($item->name == 'email') {{ $item->link }} @endif @endforeach
                        " class="flex items-center flex-wrap gap-x-3 mb-4">
...
document.getElementById('emaillink').addEventListener('click', function() {
    var email = document.getElementById('emaillink').getAttribute('data-email')
    var trim = email.trim()
