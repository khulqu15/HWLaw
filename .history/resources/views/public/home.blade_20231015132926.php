...
<div class="relative w-full bg-white pr-12 py-12">
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        <div class="col-span-5 w-full h-96 bg-blue-500 text-white rounded-r-xl relative">
            <div class="w-full py-6 px-6 absolute left-0 bottom-0">
                <h3 class="md:text-xl text-lg font-bold">Perlindungan Hukum Terhadap Pihak Ketiga Dalam Perkara Tipikor</h3>
                <p class="text-sm">Adanya perlindungan hukum dalam ketentuan hukum untuk melindungi pihak ketiga yang asetnya dirampas negara terkait kasus tindak pidana korupsi dirasakan masih belum banyak peraturan atau...</p>
            </div>
        </div>
        <div class="col-span-4 space-y-6 w-full">
            <div class="w-full h-[11.25rem] bg-blue-900 rounded-xl relative"></div>
            <div class="w-full h-[11.25rem] bg-blue-900 rounded-xl relative"></div>
        </div>
