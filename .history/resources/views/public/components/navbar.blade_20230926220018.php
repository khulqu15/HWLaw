        ...
        <div id="menu_md" class="box-border invisible transition-all w-full block shadow-xl relative py-4 px-8 bg-base-100">
            <ul class="w-full">
                ...
                <ul class="pl-3 ml-4 w-full">
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>News</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>Article</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>Press Release</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>SIP-R</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>Legal Consultation</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200"><a>Legal Insight</a></li>
                </ul>
