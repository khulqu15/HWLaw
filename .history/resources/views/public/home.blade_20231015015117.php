      ...
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[100vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 h-full w-full bg-black/60 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 text-center space-y-3 lg:w-3/4 w-full px-4">
                    <div class="text-left">
                        ...
                        <div class="flex gap-x-3">
                            <button class="btn bg-red-400 hover:bg-red-500 border-0 text-white mt-4 text-blue-900">Hubungi Kami</button>
                    ...
                    <div class="flex items-center gap-x-3">
                        ...
                        <div class="bg-blue-900 px-4 inline-block mt-4 rounded-lg py-2 text-white">
