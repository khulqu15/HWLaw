<div class="fixed top-0 w-full bg-base-100">
    <div class="w-full bg-red-400 py-2 px-8 text-white flex items-center justify-between">
        <div class="flex items-center">
            ...
            <span class="text-sm">+021-7997973 | Harry 0895-3960-0495</span>
        </div>
    ...
    <div class="flex items-center py-4 px-8 justify-between">
        ...
        <div class="hidden lg:inline-block">
            <div class="flex items-center gap-x-3">
                <div class="btn bg-base-100 hover:bg-base-200 px-4 py-2">About</div>
                <div class="btn bg-base-100 hover:bg-base-200 px-4 py-2">Our Team</div>
                <div class="btn bg-base-100 hover:bg-base-200 px-4 py-2">Practice</div>
                <div class="btn bg-base-100 hover:bg-base-200 px-4 py-2">Update</div>
                <div class="btn bg-base-100 hover:bg-base-200 px-4 py-2">Update</div>
            </div>
        </div>
        <div class="lg:hidden inline-block">
            <button class="btn bg-red-500 transition-all hover:bg-red-400 text-white text-2xl p-2">
