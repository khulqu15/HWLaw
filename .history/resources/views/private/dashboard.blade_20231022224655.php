    ...
    <div class="p-6 w-full relative">
        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                ...
                <textarea class="textarea w-full textarea-bordered h-48" placeholder="cth. Didirikan pada tahun 2021, HW Lawfirm membawa tradisi 17 tahun keahlian dalam dunia hukum..."></textarea>
            </form>
        </div>
    </div>
@endsection
