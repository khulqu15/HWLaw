...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 items-center relative px-12">
    <div class="relative">
    ...
    <div>
        ...
        <button class="btn bg-blue-900 py-3 px-5 text-white">Pelajari Lebih Lanjut</button>
    </div>
</div>
