    ...
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                ...
                <div class="form_control">
                    <label for="about_title" class="block mb-2">Judul pada konten profil</label>
                    <input value="{{ $about->content_title }}" type="text" id="about_title" placeholder="cth. 2002" required max="2150" min="1945" class="input input-bordered w-full">
                </div>
                <div class="form_control">
