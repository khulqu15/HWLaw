            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    ...
                    <div class="form_control">
                        ...
                        <input type="number" id="case_input" placeholder="cth. Menjadi Pelaksana Keadilan yang objektif, kompeten, berintegritas, dan terhormat." required max="999999" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="vission_input" class="block mb-2">Visi</label>
                        <input type="text" id="vission_input" placeholder="cth. Merealisasikan layanan hukum yang ahli dengan prioritas pada penerapan regulasi," required maxlength="255" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
