...
@section('content')
    <div class="w-full bg-white p-8 relative">
        <div>
            <label role="button" id="image1_label" for="image1_input" class="image_form w-full border hover:bg-gray-100 border-blue-900 relative overflow-hidden p-4 h-64 rounded-xl flex items-center justify-center">
