        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="benefit_form" class="mt-8">
                ...
                <div class="grid md:grid-cols-3 grid-cols-1 gap-8 mt-4">
                    <div>
                        <label role="button" id="benefit_label" for="contact_image" class="image_form w-full border hover:bg-gray-100 border-blue-900 relative overflow-hidden p-12 rounded-xl flex items-center justify-center">
                            <div id="contact_image_placeholder" class="text-center">
                                <iconify-icon class="text-4xl" icon="basil:image-outline"></iconify-icon>
                                <p>Image Preview</p>
                            </div>
                    ...
                    <div class="md:col-span-2">
                        <div class="form_control">
                            <label for="about_title" class="block mb-2">Judul</label>
                            <input value="" type="text" id="about_title" required max="2150" min="1945" class="input input-bordered w-full">
                        </div>
                        <div class="form_control">
                            <label for="description_input" class="block mb-2">Deskripsi</label>
                            <textarea id="description_input" required class="textarea w-full textarea-bordered h-32"></textarea>
                        </div>
                    </div>
                </div>
