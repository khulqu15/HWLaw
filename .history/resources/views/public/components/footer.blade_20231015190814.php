<div class="bg-blue-900 p-12 relative bg-fixed bg-center bg-cover" style="background-image: url('/assets/images/4.jpg')">
    ...
    <div class="relative flex w-full justify-center text-center mb-12">
        <div>
            <p class="text-yellow-400 mb-4 tracking-wider uppercase md:pt-0 pt-12">SILAKAN BERKONSULTASI DENGAN KAMI</p>
            <h1 class="lg:text-4xl mb-4 text-white md:text-3xl text-2xl font-bold">Accessible Legal Support for All</h1>
            <p class="text-white text-sm">Prioritas kami adalah menyediakan solusi hukum yang handal, tepat guna, ekonomis, dan kredibel.</p>
        </div>
    </div>
    <div class="w-full bg-white relative">
        <div class="w-full grid p-8 grid-cols-1 relative justify-center justify-items-center">
            <div class="w-full h-full relative pt-8">
                <div class="absolute -left-12 -top-12 inline-block px-8 py-4 bg-red-500 text-white">
                ...
                <form action="">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="relative">
                            <div class="form-group">
                                <label class="mb-2" for="name">Pertanyaan Anda</label>
                                <textarea id="name" name="name" required placeholder="cth. Bagaimana Prosedur Konsultasi Untuk Kasus Pidana Korupsi ?" class="textarea textarea-bordered h-24 w-full"></textarea>
                            </div>
            ...
            <div class="w-full bg-blue-900 p-8 mt-12 relative flex">
                ...
                <div class="lg:w-1/2 md:w-3/4 w-full relative">
                    <h4 class="lg:text-3xl md:text-2xl text-xl font-bold text-white">Jangan ragu untuk berkomunikasi dengan kami untuk pertanyaan Anda.</h4>
                    <p class="text-white mt-3">Silahkan hubungi kami melalui form atau informasi kontak yang ada di halaman ini, dengan senang hati kami akan membalas pesan Anda secepatnya.</p>
                ...
                <img src="/assets/images/pak2.png" class="h-full object-cover object-center absolute right-0 bottom-0" alt="Pak Harry Lawyer">
            </div>
        </div>
    </div>
    <div class="relative p-12 pt-20 grid grid-cols-3 gap-6 items-center" id="footer">
        <div class="relative">
            <div class="bg-[rgba(255,255,255,0.3)] backdrop-blur-md mb-5 p-6 gap-x-4 rounded-xl justify-center flex items-center w-full text-white">
                <img src="/assets/images/LOGO.png" class="w-16" alt="Logo HWLawyer">
                <h4 class="text-3xl font-bold text-white">HWLawyer</h4>
            </div>
            <p class="text-sm text-white">Di [Nama Lawfirm], kami memahami betapa pentingnya keadilan dan integritas dalam setiap aspek hukum. Sebagai firma hukum yang berdedikasi, kami menggabungkan pengetahuan mendalam, pengalaman bertahun-tahun, dan pendekatan personal untuk memastikan setiap klien mendapatkan representasi hukum terbaik. </p>
        </div>
        <div class="flex gap-x-6 items-center" id="footer-menu">
