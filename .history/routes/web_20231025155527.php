...
$router->get('/private/news/links', 'LinkController@index');
$router->get('/private/news/link/add', 'LinkController@create');
$router->post('/private/news/link/store', 'LinkController@store');
$router->get('/private/news/link/edit/{id}', 'LinkController@edit');
$router->post('/private/news/link/update/{id}', 'LinkController@update');
$router->delete('/private/news/link/delete/{id}', 'LinkController@destroy');
