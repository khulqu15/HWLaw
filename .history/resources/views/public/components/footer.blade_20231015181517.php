                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="relative">
                            <div class="form-group">
                                ...
                                <textarea id="name" name="name" required placeholder="cth. Bagaimana Prosedur Konsultasi Untuk Kasus Pidana Korupsi ?" class="input input-bordered w-full"></textarea>
                            </div>
                        </div>
                    </div>
                </form>
