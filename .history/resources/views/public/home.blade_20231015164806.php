    ...
    <div class="grid grid-cols-12 gap-6 justify-center justify-items-center mt-5">
        ...
        <div class="lg:col-span-3 col-span-12 space-y-6 w-full">
            <div class="w-full rounded-xl relative flex items-center gap-x-3">
                <img src="/assets/images/4.jpg" class="w-24 h-28 rounded-xl object-cover object-center relative" alt="Hallo Moshi Moshi">
                <div class="relative">
                    <div class="flex items-center gap-x-1">
                        <p class="text-xs">Artikel</p>
                    </div>
            ...
            <div class="w-full rounded-xl relative flex items-center gap-x-3">
                <img src="/assets/images/5.jpg" class="w-24 h-28 rounded-xl object-cover object-center relative" alt="Hallo Moshi Moshi">
                <div class="relative">
                    <div class="flex items-center gap-x-1">
                        <p class="text-xs">Artikel</p>
                    </div>
            ...
            <div class="w-full rounded-xl relative flex items-center gap-x-3">
                <img src="/assets/images/6.jpg" class="w-24 h-28 rounded-xl object-cover object-center relative" alt="Hallo Moshi Moshi">
                <div class="relative">
                    <div class="flex items-center gap-x-1">
                        <p class="text-xs">Artikel</p>
                    </div>
...
<div class="bg-blue-900 p-12 relative bg-fixed bg-center bg-cover" style="background-image: url('/assets/images/3.jpg')">
    ...
    <div class="flex relative items-center justify-center gap-6">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/5Ac2x6zWKOo?si=SqjwasPgXCrF688E&amp;start=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/5Ac2x6zWKOo?si=SqjwasPgXCrF688E&amp;start=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/5Ac2x6zWKOo?si=SqjwasPgXCrF688E&amp;start=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
    <div class="flex w-full relative justify-center text-center mb-12 mt-8">
        <button class="btn bg-white hover:bg-gray-200 text-blue-900 btn-wide">Lebih Banyak</button>
    </div>
</div>
...
<div class="bg-white p-12 relative">
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 relative items-center justify-center gap-6">
        <div><img src="/assets/images/partner1.png" class="h-20" alt="Partner HW Lawyer 1"></div>
        <div><img src="/assets/images/partner2.png" class="h-20" alt="Partner HW Lawyer 2"></div>
        <div><img src="/assets/images/partner3.png" class="h-20" alt="Partner HW Lawyer 3"></div>
        <div><img src="/assets/images/partner4.png" class="h-20" alt="Partner HW Lawyer 4"></div>
        <div><img src="/assets/images/partner5.png" class="h-20" alt="Partner HW Lawyer 5"></div>
        <div><img src="/assets/images/partner6.png" class="h-20" alt="Partner HW Lawyer 6"></div>
    </div>
</div>
