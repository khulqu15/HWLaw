<div class="bg-blue-900 p-12 relative bg-fixed bg-center bg-cover" style="background-image: url('/assets/images/4.jpg')">
    ...
    <div class="relative p-12 grid grid-cols-2 items-center" id="footer">
        <div class="flex gap-x-6 items-center" id="footer-menu">
            <div>
                <h5>Quick Links</h5>
                <ul class="list-decimal pl-5">
                    <li class="relative before:content-[''] before:block before:w-4 before:h-2 before:bg-yellow-400 before:rotate-45 before:absolute before:-left-7 before:top-2/4 before:-translate-y-2/4">
                        Item 1
                    </li>
                    <li class="relative before:content-[''] before:block before:w-4 before:h-2 before:bg-yellow-400 before:rotate-45 before:absolute before:-left-7 before:top-2/4 before:-translate-y-2/4">
                        Item 2
