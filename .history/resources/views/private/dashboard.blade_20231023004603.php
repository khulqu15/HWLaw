        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <div class="grid grid-cols-2 mt-4 items-center gap-x-6">
                <label role="button" id="image1_label" for="image1" class="image_form w-full border hover:bg-gray-100 border-blue-900 relative overflow-hidden p-4 rounded-xl flex items-center justify-center">
                    ...
                    <input type="file" id="image1" class="hidden">
                ...
                <label role="button" id="image2_label" for="image2" class="image_form w-full border hover:bg-gray-100 border-blue-900 relative overflow-hidden p-4 rounded-xl flex items-center justify-center">
                    ...
                    <input type="file" id="image2" class="hidden">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        ...
                        <input type="number" id="year_input" placeholder="cth. 2002" required max="2150" min="1945" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="case_input" class="block mb-2">Jumlah kasus yang telah diselesaikan</label>
                        <input type="number" id="case_input" placeholder="cth. 100" required max="999999" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="year_input" class="block mb-2">Visi</label>
                        <input type="number" id="year_input" placeholder="cth. 2002" required maxlength="255" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="case_input" class="block mb-2">Misi</label>
                        <input type="number" id="case_input" placeholder="cth. 100" required maxlength="255" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
