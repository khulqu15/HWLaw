...
<div class="w-full relative p-8 bg-white">
    <div class="space-y-3">
        ...
        <form id="category_form" class="space-y-3">
            <div class="form-control">
                ...
                <div class="input-group">
                    <input id="name_input_text" value="{{ !isset($link) ? '' : $link->name }}" required maxlength="50" placeholder="cth. Whatsapp, Facebook, Twitter, Youtube" type="text" class="w-full input input-bordered hidden" >
                    <select id="name_input_select" class="select select-bordered w-full">
                    ...
                    <button class="btn btn-primary" id="name_input_toggle">
            ...
            <div class="form-control">
                ...
                <div class="input-group">
                    <select required id="category_input_select" class="select select-bordered w-full">
                        <option value="">Pilih Kategori</option>
                        <option value="media">Media Sosial</option>
                        <option value="kontak">Kontak</option>
                    </select>
                    <input id="category_input_text" value="{{ !isset($link) ? '' : $link->category }}" required maxlength="50" placeholder="cth. Berita, Artikel" type="text" class="w-full input hidden input-bordered" >
                    <button class="btn btn-primary" id="category_input_toggle">
                        <iconify-icon icon="tabler:edit" class="text-2xl"></iconify-icon>
                    </button>
                </div>
            </div>
            <div class="form-control">
                ...
                <input id="link_input" value="{{ !isset($link) ? '' : $link->name }}" required maxlength="50" placeholder="cth. github.com/khulqu15" type="text" class="w-full input input-bordered" >
            </div>
