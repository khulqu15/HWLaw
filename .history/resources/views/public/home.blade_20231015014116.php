        ...
        <div class="w-full h-[100vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 h-full w-full bg-black/60 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="grid grid-cols-2 text-center space-y-3 lg:w-3/4 w-full px-4">
                    <div class="text-left">
                        <p class="text-red-400 mb-4 tracking-wider uppercase">Integritas yang Tak Tergoyahkan</p>
                        <h3 class="text-4xl text-white font-bold">Biarkan Keadilan Berdiri, <br> Meski Semesta Berkecamuk.</h3>
                        <p class="text-white">HW Lawfirm adalah kantor hukum yang menawarkan berbagai jenis bantuan hukum yang komprehensif kepada klien, termasuk dalam urusan bisnis dan perselisihan korporasi di lintas bidang industri</p>
                    </div>
                    <div>
