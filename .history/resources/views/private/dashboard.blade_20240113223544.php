    ...
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="video_motto" class="block mb-2">Header Bagian Formulir Contact</label>
                        <input value="{{ $content->form_contact_motto }}" type="text" id="video_motto" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="video_title" class="block mb-2">Title Bagian Formulir Contact</label>
                        <input value="{{ $content->form_contact_title }}" type="text" id="video_title" required maxlength="200" min="0" class="input input-bordered w-full">
                    </div>
                </div>
            </form>
