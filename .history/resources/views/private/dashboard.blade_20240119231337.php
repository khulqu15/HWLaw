        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="form_control">
                    ...
                    <input value="{{ $about->about_title }}" type="text" id="about_title" placeholder="cth. 2002" required max="2150" min="1945" class="input input-bordered w-full">
                </div>
                <div class="form_control">
                    <label for="about_description" class="block mb-2">Deskripsi pada halaman profil</label>
                    <textarea id="about_description" required class="textarea w-full textarea-bordered h-32" placeholder="cth. Didirikan pada tahun 2021, HW Lawfirm membawa tradisi 17 tahun keahlian dalam dunia hukum...">{{ $about->description }}</textarea>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
