    ...
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                ...
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="header_motiovation_title" class="block mb-2">Judul Motivasi Bagian Header</label>
                        <input value="{{ $content->header_motiovation_title }}" type="text" id="header_motiovation_title" required maxlength="200" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="header_title" class="block mb-2">Sub-Judul Bagian Header</label>
                        <input value="{{ $content->header_title }}" type="text" id="header_title" required maxlength="200" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
