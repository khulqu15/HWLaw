    ...
    <div class="w-full py-20 container relative mx-auto md:px-12 px-4">
        ...
        <div class="mb-12 mt-16 bg-blue-900 relative w-full overflow-hidden">
            <div class="grid grid-cols-12 text-white">
                <div class="col-span-4 p-8 flex items-center">
                    <div class="space-y-3">
                        <h3 class="text-3xl font-semibold">Hukum Pidana</h3>
                        <p>Jika anda membutuhkan layanan kami, silahkan klik tombol di bawah ini atau silahkan datang ke kantor kami.</p>
                        <button class="btn bg-red-600 hover:bg-red-700 mt-6 border-3 text-white border-white btn-wide">Hubungi Kami</button>
                    </div>
                </div>
