            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="name_input" class="block mb-2">Didirikan pada tahun</label>
                        <input value="{{ $user->name }}" type="text" id="name_input" placeholder="cth. Admin Keren" required max="2150" min="1945" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
