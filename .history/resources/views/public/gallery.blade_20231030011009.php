    ...
    <div class="w-full pb-20 container relative mx-auto md:px-12 px-4">
        ...
        <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 grid-cols-1 gap-6 relative">
            @foreach ($news as $item)
                <label for="show_data" class="card card-compact bg-base-100 shadow-xl" data-name="{{ $item->name }}"
            ...
            <div class="modal">
                <div class="modal-box">
                    ...
                    <img src="/assets/images/1.png" class="w-full h-64 object-cover object-center" alt="Album"/>
                    <div class="modal-action">
                        <label for="show_data" class="btn">Close!</label>
                    </div>
                </div>
            </div>
        </div>
