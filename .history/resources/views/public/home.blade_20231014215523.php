  ...
  <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[100vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 h-full w-full bg-white/30 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="text-center space-y-3">
                    <img src="/assets/images/LOGO.png" alt="HW Logo" class="w-48 inline-block">
                    <div class="bg-blue-900 px-4 mt-4 py-2 text-white">
                        <h2 class="text-xl font-bold">Membela Keadilan, Menghargai Klien.</h2>
                        <p class="text-sm">Mengatasi Tantangan Hukum dengan Keahlian</p>
                    </div>
                </div>
            </div>
        </div>
