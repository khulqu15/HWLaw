    ...
    <div class="w-full bg-white p-8 relative">
        <form id="practice_form" class="space-y-4">
            ...
            <div class="form_control">
                ...
                <textarea id="description_" required class="textarea w-full textarea-bordered h-32" placeholder="cth. Didirikan pada tahun 2021, HW Lawfirm membawa tradisi 17 tahun keahlian dalam dunia hukum...">{{ !isset($practice) ? '' : $practice->description }}</textarea>
            </div>
            <div>
