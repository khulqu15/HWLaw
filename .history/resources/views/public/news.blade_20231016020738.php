...
<div class="bg-gray-100">
    <div class="w-full pb-20 container relative mx-auto md:px-12 px-4">
        <div class="flex relative -top-6 rounded-xl gap-x-3 items-center mb-8 p-6 bg-white shadow-2xl">
            <div class="grow w-full">
                <input type="text" placeholder="Cari Berdasarkan Judul" class="input input-bordered w-full" />
            </div>
            <div class="grow w-full">
                <select class="select select-bordered w-full">
                    <option disabled selected>Pilih Area Kerja</option>
            ...
            <div>
                <button class="btn border rounded-lg">
                    <iconify-icon icon="basil:sort-solid" class="text-black/60"></iconify-icon>
                </button>
            </div>
        </div>
