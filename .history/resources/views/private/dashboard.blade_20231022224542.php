...
@section('content')
    <div class="p-6 w-full relative">
        ...
        <div class="w-full relative mt-8" id="about_form">
            ...
            <form id="form_about">
                <textarea class="textarea w-full textarea-bordered" placeholder="cth. Didirikan pada tahun 2021, HW Lawfirm membawa tradisi 17 tahun keahlian dalam dunia hukum..."></textarea>
            </form>
        </div>
    </div>
@endsection
