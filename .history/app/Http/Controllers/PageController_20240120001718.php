...
class PageController extends Controller {
    ...
    public function uploadImage(Request $request) {
        ...
        if($request->hasFile('logo_image')) {
            ...
            $imageName = time().'_logo_image_'.$request->logo_image->extension();
        ...
        if($request->hasFile('area_image')) {
            ...
            $imageName = time().'_logo_image_'.$request->area_image->extension();
        ...
        if($request->hasFile('about_image')) {
            ...
            $imageName = time().'_logo_image_'.$request->about_image->extension();
        ...
        if($request->hasFile('contact_image')) {
            ...
            $imageName = time().'_logo_image_'.$request->contact_image->extension();
