...
<div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 relative px-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
