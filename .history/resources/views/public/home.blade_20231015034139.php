...
<div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 relative md:p-20 p-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
    ...
    <div class="relative">
        <img src="/assets/images/pak1.png" class="w-full h-full object-center object-cover mx-auto" alt="Pak Harry Lawyer">
    </div>
</div>
