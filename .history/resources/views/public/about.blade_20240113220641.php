            ...
            <div>
                ...
                <div class="mt-6 grid grid-cols-2">
                    <div class="relative">
                        ...
                        <h3 class="text-xl font-semibold my-2">{{ $about->benefit1 }}</h3>
                        <p class="text-sm text-black/70">{{ $about->benefit1_text }}</p>
                    </div>
                    <div class="relative">
                        ...
                        <h3 class="text-xl font-semibold my-2">{{ $about->benefit2 }}</h3>
                        <p class="text-sm text-black/70">{{ $about->benefit2_text }}</p>
                    </div>
                </div>
            </div>
            <div>
