<div class="bg-blue-900 p-12 relative bg-fixed bg-center bg-cover" style="background-image: url('/assets/images/4.jpg')">
    ...
    <div class="relative p-12 pt-20 grid grid-cols-3 items-center" id="footer">
        <div class="relative">
            <div class="bg-gradient-to-r from-blue-500 to-purple-600 p-10 flex items-center justify-center min-h-screen">
                <div class="bg-[rgba(255,255,255,0.1)] backdrop-blur-md p-6 rounded-xl">
                    Konten di dalam elemen "glass"
                </div>
            </div>
        </div>
