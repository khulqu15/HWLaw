...
<div class="relative container w-full bg-white py-12">
    <div class="flex w-full justify-center text-center mb-6">
        <div>
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        <div class="col-span-5 w-full h-96 bg-blue-900 rounded-r-xl"></div>
        <div class="col-span-4 space-y-6 w-full">
            <div class="w-full h-[11.25rem] bg-blue-500 rounded-xl relative"></div>
            <div class="w-full h-[11.25rem] bg-blue-500 rounded-xl relative"></div>
        </div>
    </div>
</div>
