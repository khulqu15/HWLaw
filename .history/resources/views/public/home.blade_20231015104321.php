        ...
        <div class="w-full h-[100vh] bg-blue-500 relative">
            ...
            <div class="absolute space-y-3 h-full w-full bg-black/60 p-8 bottom-0 items-center justify-center flex left-0 rounded-tr-2xl">
                <div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 space-y-3 lg:w-10/12 pt-12 w-full px-4">
                    ...
                    <div class="flex items-center justify-center gap-x-3 text-left lg:inline-block hidden">
...
<div class="min-h-screen grid md:grid-cols-2 grid-cols-1 gap-x-8 items-center relative px-12">
    <div class="relative text-center md:mt-0 mt-12">
        ...
        <div class="relative">
            ...
            <div class="flex flex-wrap items-stretch text-left">
                <div class="bg-blue-900 py-4 pr-4 pl-6 text-white md:rounded-l-2xl w-full lg:w-1/4">
                    <h5 class="text-lg font-semibold">Advokat Terpercaya di Indonesia</h5>
                    <p class="text-xs text-white/80">Mengkomunikasikan dengan Ahli, Efisien, Penuh Semangat, Optimis, Melampaui Ekspektasi.</p>
                </div>
                <div class="bg-gray-200 p-4 text-blue-900 w-full md:w-4/12 lg:w-1/3">
                    <p class="text-sm font-semibold">Lawyer Berpengalaman</p>
                    <h5 class="text-3xl font-semibold">5+</h5>
                    <p class="text-xs">Tahun</p>
                </div>
                <div class="bg-red-500 p-4 text-white w-full md:w-4/12 lg:w-1/3">
                ...
                <div class="bg-gray-100 p-4 text-red-600 rounded-r-2xl w-full md:w-4/12 lg:w-1/3">
    ...
    <div>
        ...
        <h1 class="text-6xl font-bold mb-12">Kami Sangat Menghargai Prinsip Keadilan.</h1>
...
<div class="grid md:grid-cols-2 grid-cols-1 gap-x-8 relative items-center md:p-20 p-12 bg-blue-900 relative bg-fixed bg-cover bg-center" style="background-image: url('/assets/images/6.jpg')">
    ...
    <div class="md:col-span-2 relative">
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full">
            <div class="w-full h-64 p-6 border-b-[1px] border-blue-900 bg-blue-900 transition-all text-white">
                <iconify-icon icon="octicon:law-24" class="text-6xl"></iconify-icon>
            ...
            <div class="w-full h-64 p-6 border-b-[1px] border-blue-900 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                <iconify-icon icon="uit:bag" class="text-6xl"></iconify-icon>
            ...
            <div class="w-full h-64 p-6 border-x-[1px] border-b-[1px] border-blue-900 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                <iconify-icon icon="teenyicons:contract-outline" class="text-6xl"></iconify-icon>
            ...
            <div class="w-full h-64 p-6 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                <iconify-icon icon="guidance:bank" class="text-6xl"></iconify-icon>
            ...
            <div class="w-full h-64 p-6 border-x-[1px] border-blue-900 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                <iconify-icon icon="cil:industry" class="text-6xl"></iconify-icon>
                <h3 class="text-2xl font-semibold mb-2">Hukum Pidana</h3>
                <p>HW Lawfirm berpengalaman dalam menangani perkara pidana, baik melakukan pendampingan di kepolisian...</p>
            </div>
            <div class="w-full h-64 p-6 border-blue-900 bg-gray-100 hover:bg-blue-900 transition-all hover:text-white">
                <iconify-icon icon="iconoir:page-search" class="text-6xl"></iconify-icon>
