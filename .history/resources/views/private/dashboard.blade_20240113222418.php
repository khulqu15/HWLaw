            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="year_input" class="block mb-2">Header Bagian About</label>
                ...
                <div class="form_control">
                    <label for="description_input" class="block mb-2">Description Bagian About</label>
                    <textarea id="description_input" required class="textarea w-full textarea-bordered h-32">{{ $content->about_description }}</textarea>
                </div>
            </form>
