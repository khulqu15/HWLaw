            ...
            <div class="flex items-center gap-x-1">
                ...
                <div class="dropdown dropdown-hover dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li><a href="/practice#pidana">Pidana</a></li>
                        <li><a href="/practice#perdata">Perdata</a></li>
                        <li><a href="/practice#kepailitan">Kepailitan</a></li>
                        <li><a href="/practice#perbankan">Perbankan</a></li>
                        <li><a href="/practice#kontrak">Kontrak</a></li>
                        <li><a href="/practice#perusahaan">Perusahaan</a></li>
                    </ul>
                  </div>
                <div class="dropdown dropdown-hover dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                        ...
                        <li><a href="/news#PR">Press Release</a></li>
                        <li><a href="/news#SIPR">SIP-R</a></li>
                        <li><a href="/news#LC">Legal Consultation</a></li>
                        <li><a href="/news#LI">Legal Insight</a></li>
                    </ul>
                  </div>
                <a href="/login" class="btn bg-base-100 hover:bg-base-200 px-4 py-2 border-0"><iconify-icon icon="solar:user-bold-duotone"></iconify-icon></a>
            </div>
        </div>
