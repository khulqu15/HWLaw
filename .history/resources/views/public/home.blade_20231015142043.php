...
<div class="relative w-full bg-white pr-12 md:pl-0 pl-12 py-12">
    ...
    <div class="grid grid-cols-12 gap-6 justify-center justify-items-center mt-5">
        <div class="lg:col-span-5 md:col-span-7 col-span-12 w-full h-96 bg-blue-500 text-white md:rounded-r-none rounded-r-xl rounded-xl overflow-hidden relative">
