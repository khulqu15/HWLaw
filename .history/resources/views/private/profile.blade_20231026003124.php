            ...
            <form id="form_about" class="space-y-4 mt-4">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    ...
                    <div class="form_control">
                        ...
                        <input value="{{ $user->email }}" type="email" id="cases_input" placeholder="cth. admin@hw.law.com" required class="input input-bordered w-full">
                    </div>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="password_input" class="block mb-2">Password</label>
                        <input type="password" id="password_input" required class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="repassword_input" class="block mb-2">Password</label>
                        <input type="password" id="repassword_input" required class="input input-bordered w-full">
                    </div>
                </div>
