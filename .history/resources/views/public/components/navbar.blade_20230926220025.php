    ...
    <div class="lg:hidden inline-block w-full">
        <div id="menu_md" class="box-border invisible transition-all w-full block shadow-xl relative py-4 px-8 bg-base-100">
            <ul class="w-full">
                ...
                <ul class="pl-3 ml-4 w-full">
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>News</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>Article</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>Press Release</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>SIP-R</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>Legal Consultation</a></li>
                    <li class="w-full bg-base-100 py-2 px-4 hover:bg-base-200 w-full"><a>Legal Insight</a></li>
                </ul>
