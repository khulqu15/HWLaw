...
<div class="relative w-full bg-white md:pr-12 px-12 py-12">
    ...
    <div class="grid grid-cols-12 gap-x-6 justify-center justify-items-center mt-5">
        <div class="lg:col-span-5 md:col-span-7 col-span-12 w-full h-96 bg-blue-500 text-white md:rounded-r-xl rounded-xl overflow-hidden relative">
