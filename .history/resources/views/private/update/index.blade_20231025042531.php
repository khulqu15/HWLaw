...
<div class="w-full relative p-8 bg-white">
    <div class="space-y-3">
        ...
        <form class="flex items-center gap-x-3 justify-between">
            <div class="form_control grow w-full">
                <div class="input-group">
                    <input name="title" id="name_input" value="{{ request('title') }}" type="text" class="input text-sm w-full input-bordered" placeholder="Cari Berdasarkan Judul">
        ...
        <div>
            @if ($count_news > 0)
            <div class="grid lg:grid-cols-3 gap-3 md:grid-cols-2 grid-cols-1">
