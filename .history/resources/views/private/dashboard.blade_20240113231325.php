...
@section('content')
    <div class="p-6 w-full relative">
        <div class="w-full relative mt-8" id="about_form">
            ...
            <div>
                <label role="button" id="image1_label" for="cover_image_input" class="image_form w-full border hover:bg-gray-100 border-blue-900 relative overflow-hidden p-32 rounded-xl flex items-center justify-center">
                    ...
                    @if ($about->cover_image)
                        <img id="image1_preview" src="/assets/images/{{ $about->cover_image }}" class="absolute image_preview w-full h-full object-cover object-center" alt="">
                    @else
