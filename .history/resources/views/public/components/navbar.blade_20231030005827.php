<div class="fixed top-0 w-full bg-base-100 z-50">
    ...
    <div class="flex items-center py-4 px-8 justify-between">
        ...
        <div class="hidden lg:inline-block">
            <div class="flex items-center gap-x-1">
                ...
                <a href="/gallery" class="btn bg-base-100 hover:bg-base-200 px-4 py-2 border-0">Gallery</a>
    ...
    <div class="lg:hidden inline-block w-full">
        <div id="menu_md" class="box-border hidden transition-all w-full block shadow-xl relative py-4 px-8 bg-base-100">
            <ul class="w-full">
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full normal-case"><a href="/">Home</a></li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full normal-case"><a href="/about">About</a></li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full normal-case"><a href="/gallery">Gallery</a></li>
                <li class="bg-base-100 rounded-lg hover:bg-base-200 px-4 py-2 border-0 w-full normal-case"><a href="/#practice">Practice</a></li>
