            ...
            <form id="form_content" class="space-y-4 mt-4 mb-8">
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="about_motto" class="block mb-2">Header Bagian About</label>
                        <input value="{{ $content->about_motto }}" type="text" id="about_motto" required maxlength="100" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="about_title" class="block mb-2">Title Bagian About</label>
                        <input value="{{ $content->about_title }}" type="text" id="about_title" required maxlength="100" min="0" class="input input-bordered w-full">
                    </div>
                </div>
                <div class="form_control">
                    <label for="about_description" class="block mb-2">Description Bagian About</label>
                    <textarea id="about_description" required class="textarea w-full textarea-bordered h-32">{{ $content->about_description }}</textarea>
                </div>
                <div class="grid grid-cols-2 items-center gap-x-3">
                    <div class="form_control">
                        <label for="year_input" class="block mb-2">About Poin 1 Title</label>
                        <input value="{{ $content->about_motto }}" type="text" id="year_input" required maxlength="100" class="input input-bordered w-full">
                    </div>
                    <div class="form_control">
                        <label for="cases_input" class="block mb-2">About Poin 1 Description</label>
                        <input value="{{ $content->about_title }}" type="text" id="cases_input" required maxlength="100" min="0" class="input input-bordered w-full">
                    </div>
                </div>
            </form>
