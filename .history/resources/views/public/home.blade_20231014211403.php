  ...
  <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full">
        <div class="w-full h-[80vh] bg-blue-500 relative">
            ...
            <div class="absolute lg:w-1/2 md:w-3/4 w-full p-8 bg-blue-900 bottom-0 left-0 rounded-tr-xl">
                <h2 class="text-2xl text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus, excepturi.</h2>
