...
<div class="toast toast-top toast-end">
    ...
    <div class="alert alert-danger bg-red-500 text-white flex items-center">
        <iconify-icon icon="icon-park-solid:error"></iconify-icon>
        <span>Toast for error Lorem, ipsum dolor sit amet consectetur adipisicing elit. Illo, asperiores?</span>
    </div>
</div>
@endsection
